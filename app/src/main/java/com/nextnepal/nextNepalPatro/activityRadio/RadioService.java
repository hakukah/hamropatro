...
public class RadioService extends Service implements Player.EventListener, AudioManager.OnAudioFocusChangeListener {
    ...
    public static final String ACTION_PLAY = "com.nextnepal.nextNepalPatro.activityRadio.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.nextnepal.nextNepalPatro.activityRadio.ACTION_PAUSE";
    public static final String ACTION_STOP = "com.nextnepal.nextNepalPatro.activityRadio.ACTION_STOP";
    ...
    public boolean onUnbind(Intent intent) {
        ...
        if(status.equals(CONST.RADIO_IDLE))
            stopSelf();
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        ...
        switch (playbackState) {
            case Player.STATE_BUFFERING:
                status = CONST.RADIO_LOADING;
                break;
            case Player.STATE_ENDED:
                status = CONST.RADIO_STOPPED;
                break;
            case Player.STATE_IDLE:
                status = CONST.RADIO_IDLE;
                break;
            case Player.STATE_READY:
                status = playWhenReady ? CONST.RADIO_PLAYING : CONST.RADIO_PAUSED;
                break;
            default:
                status = CONST.RADIO_IDLE;
                break;
    ...
    public void onPlayerError(ExoPlaybackException error) {
        ...
        EventBus.getDefault().post(CONST.RADIO_ERROR);
    }
...
//        DefaultHttpDataSourceFactory dataSourceFactory = new DefaultHttpDataSourceFactory(getUserAgent());
    ...
    public boolean isPlaying(){
        ...
        return this.status.equals(CONST.RADIO_PLAYING);
    }
